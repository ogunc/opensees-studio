...
def build_rc_frame_gravity() -> Project:
    ...
    return Project(
        ...
        materials=[
            Concrete01(
                id=1, name="Core-Conc", fpc=CONC_CORE_FPC, epsc0=-0.004, fpcu=-5.0, epsU=-0.014
            ),
            Concrete01(
                id=2, name="Cover-Conc", fpc=CONC_COVER_FPC, epsc0=-0.002, fpcu=0.0, epsU=-0.006
            ),
            Steel01(id=3, name="Steel-60", Fy=STEEL_FY, E0=STEEL_E, b=STEEL_B),
        ],
        sections=[
            ...
            ElasticSection(
                ...
                Iy=BEAM_IZ,
                G=1500.0,
                J=1.0,  # placeholders for 3D round-trip
            ),
        ],
        elements=[
