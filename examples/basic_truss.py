    ...
    return Project(
        ...
        nodes=[
            Node(
                id=1,
                name="Base-L",
                coords=(x1 * IN_TO_M, y1 * IN_TO_M, 0.0),
                restraint=(True, True, False, False, False, False),
            ),
            Node(
                id=2,
                name="Base-M",
                coords=(x2 * IN_TO_M, y2 * IN_TO_M, 0.0),
                restraint=(True, True, False, False, False, False),
            ),
            Node(
                id=3,
                name="Base-R",
                coords=(x3 * IN_TO_M, y3 * IN_TO_M, 0.0),
                restraint=(True, True, False, False, False, False),
            ),
        ...
        sections=[],
        elements=[
            TrussElement(id=1, name="Bar-1-4", nodes=(1, 4), area=a1, material_id=1),
            TrussElement(id=2, name="Bar-2-4", nodes=(2, 4), area=a2, material_id=1),
            TrussElement(id=3, name="Bar-3-4", nodes=(3, 4), area=a3, material_id=1),
        ],
