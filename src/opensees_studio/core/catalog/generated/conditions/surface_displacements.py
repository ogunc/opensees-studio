...
# File: surface_displacements.py
# Generated from schemas.json sha256:42032585df71, codegen v2
# Source: schemas.json -- Book: Loads / CONDITION: Surface_Displacements
#
...
class SurfaceDisplacementsSpec(BaseModel):
    model_config = ConfigDict(
        json_schema_extra={
            "x-gid-name": "Surface_Displacements",
            "x-book": "Loads",
        }
    )
