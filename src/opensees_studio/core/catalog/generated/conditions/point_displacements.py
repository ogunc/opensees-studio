...
# File: point_displacements.py
# Generated from schemas.json sha256:42032585df71, codegen v2
# Source: schemas.json -- Book: Loads / CONDITION: Point_Displacements
#
...
class PointDisplacementsSpec(BaseModel):
    model_config = ConfigDict(
        json_schema_extra={
            "x-gid-name": "Point_Displacements",
            "x-book": "Loads",
        }
    )
