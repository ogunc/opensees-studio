...
# File: point_rigid_link_slave_nodes.py
# Generated from schemas.json sha256:42032585df71, codegen v2
# Source: schemas.json -- Book: Constraints / CONDITION: Point_Rigid_link_slave_nodes
#
...
class PointRigidLinkSlaveNodesSpec(BaseModel):
    model_config = ConfigDict(
        json_schema_extra={
            "x-gid-name": "Point_Rigid_link_slave_nodes",
            "x-book": "Constraints",
        }
    )
